...
STEER_HOLD_FRAMES      = 20     # sustain a steering decision for this many cycles (~100ms at 200Hz)
...
def processing_task():
    ...
    # Steering inertia: hold a non-zero decision for STEER_HOLD_FRAMES cycles so
    # the game's physics receives a sustained signal rather than rapid 1.0/0.0 flicker.
    if steering != 0.0:
